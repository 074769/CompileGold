...
namespace CompilePalX
{
    ...
    static class ConfigurationManager
    {
        ...
        public static void AssembleParameters()
        {
            ...
            CompileProcesses.Add(new HlfixProcess());
            CompileProcesses.Add(new ResourceGenerator());
            CompileProcesses.Add(new ResourcePackager());
        ...
        public static Preset NewPreset(Preset preset, bool initializeDefaultProcesses = true)
        {
            ...
            {
                string[] defaultProcesses = new string[] { "HLFIX", "HLCSG", "HLBSP", "HLVIS", "HLRAD", "RESGEN", "PACK", "COPY", "GAME" };
